    ...
    <section id="contact" className="py-20 relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className={`${isMobile ? 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300' : 'bg-white dark:bg-gray-800 hover:bg-primary-500 text-gray-600 hover:text-white dark:text-gray-300 dark:hover:text-white'} transition-colors duration-300 h-10 w-10 rounded-full flex items-center justify-center ${isMobile ? '' : 'shadow-md'}`}
                >
          ...
          >
            {/* Success message - simplified on mobile */}
            {isSubmitted && (
              <motion.div 
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className={`absolute inset-0 ${isMobile ? 'bg-primary-500' : 'bg-gradient-to-br from-primary-400 to-primary-600'} flex items-center justify-center p-8 z-10`}
              >
                <motion.div
                  initial={isMobile ? { opacity: 0 } : { scale: 0.9, opacity: 0 }}
                  animate={isMobile ? { opacity: 1 } : { scale: 1, opacity: 1 }}
                  transition={isMobile ? {} : { type: "spring", stiffness: 150, damping: 15, delay: 0.1 }}
