...
const Projects = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: "IoT-based smart home system for controlling and automating home devices with voice commands.",
      image: "/project5.jpg",
      category: ["iot", "web"],
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  <a 
                    href={project.link} 
                    className="text-primary-500 hover:text-primary-700 dark:hover:text-primary-300 font-medium flex items-center"
                  >
                    Live Demo
              ...
              {/* Hover overlay */}
              <div className="absolute inset-0 bg-gradient-to-b from-transparent to-primary-500/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center p-6">
                <div className="text-white transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                  <div className="flex gap-4">
                    <a 
                      href={project.link} 
                      className="bg-white text-primary-500 hover:bg-gray-100 px-4 py-2 rounded-full font-medium flex items-center"
                    >
                      View Project
                      <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    ...
                    <a 
                      href={project.github} 
                      className="bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-full font-medium"
                    >
                      Code
                    </a>
                  </div>
